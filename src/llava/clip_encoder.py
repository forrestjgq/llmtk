...
class Tokenizer:
    ...
    def encode(self,query: str):
        ...
        return self.tokenizer_image_token(prompt, IMAGE_TOKEN_INDEX, return_tensors="pt")
...
if __name__ == "__main__":
    ...
    ids = tk.encode(prompt).to(cpu)
    print('ids: ', ids)

    feat = vt.encode_images(image_file).to(cpu)
